...
EQUIPMENT_TYPES.kitchen_exhaust_hood = {
  name: "Kitchen Exhaust Hood",
  icon: "💨",
  sections: [
    {
      id: "hood_canopy",
      title: "Hood Canopy & Structure",
      type: "checklist",
      items: [
        { id: "canopy_condition", label: "Canopy free of dents, corrosion, or structural damage" },
        { id: "canopy_mounting", label: "Hood securely mounted to wall/ceiling — no movement" },
        { id: "canopy_overhang", label: "Canopy overhangs cooking equipment per NFPA 96 (6\" front/sides)" },
        { id: "grease_gutters", label: "Grease gutters/drip channels present and sloped to cup" },
        { id: "grease_cup", label: "Grease collection cup/canister present and accessible" },
        { id: "cup_not_full", label: "Grease collection cup not full or overflowing" },
        { id: "no_grease_pooling", label: "No pooled grease on canopy exterior surfaces" },
        { id: "lights_working", label: "Hood lighting operational (if equipped)" }
      ],
      extraFields: [
        { id: "hood_width", type: "text", label: "Hood Width (inches)" },
        { id: "hood_depth", type: "text", label: "Hood Depth (inches)" },
        { id: "mounting_height", type: "text", label: "Mounting Height Above Cooking Equip (inches)" }
      ],
      notesField: true
    },
    {
      id: "filters",
      title: "Grease Filters & Baffles",
      type: "checklist",
      items: [
        { id: "filters_present", label: "All filter positions occupied — no gaps" },
        { id: "filter_type_baffle", label: "Baffle-type filters installed (NFPA 96 compliant)" },
        { id: "filters_seated", label: "Filters seated correctly — no tilting or gaps at edges" },
        { id: "filters_acceptable", label: "Filters acceptably clean — not saturated with grease" },
        { id: "filter_not_heavy", label: "No heavily-loaded/dripping filters (fire hazard)" },
        { id: "filter_not_damaged", label: "No bent, deformed, or missing baffles" },
        { id: "filter_removal_ok", label: "Filters removable for cleaning (not obstructed)" }
      ],
      extraFields: [
        {
          id: "filter_condition",
          type: "radio",
          label: "Filter Condition Rating",
          options: ["Clean", "Moderate — Clean Soon", "Heavy Build-Up — Clean Now"]
        }
      ],
      notesField: true
    },
    {
      id: "exhaust_fan",
      title: "Exhaust Fan & Motor",
      type: "checklist",
      items: [
        { id: "fan_running", label: "Exhaust fan running when hood switch activated" },
        { id: "fan_correct_direction", label: "Fan pulling air through hood in correct direction" },
        { id: "fan_no_noise", label: "No unusual bearing noise, vibration, or wobble" },
        { id: "belt_condition", label: "Belt good condition — no cracks, fraying, glazing (if belt drive)" },
        { id: "belt_tension", label: "Belt tension correct — ~1/2\" deflection (if belt drive)" },
        { id: "motor_mounts", label: "Motor mounting hardware tight — no looseness" },
        { id: "fan_wheel_clean", label: "Fan wheel/impeller reasonably clean — no heavy grease buildup" },
        { id: "fan_housing_clean", label: "Fan housing free of excessive grease accumulation" },
        { id: "access_panel", label: "Fan access panel operable for maintenance" }
      ],
      extraFields: [
        { id: "fan_motor_amps", type: "text", label: "Fan Motor Amps (measured)" },
        { id: "motor_nameplate_amps", type: "text", label: "Motor Nameplate FLA" },
        { id: "motor_hp", type: "text", label: "Motor HP" }
      ],
      notesField: true
    },
    {
      id: "airflow_measurement",
      title: "Airflow & Face Velocity",
      type: "checklist",
      items: [
        { id: "visible_draw", label: "Visible draw confirmed — tissue/smoke test at filter face" },
        { id: "face_velocity_adequate", label: "Face velocity adequate (≥100 FPM light / ≥150 FPM heavy duty)" },
        { id: "no_smoke_spill", label: "No smoke spillage observed at cooking equipment during operation" },
        { id: "negative_pressure", label: "Kitchen in slight negative pressure relative to adjacent spaces" },
        { id: "makeup_air_balanced", label: "Make-up air appears balanced with exhaust" }
      ],
      extraFields: [
        { id: "reading_1", type: "text", label: "Face Velocity Reading 1 (FPM)" },
        { id: "reading_2", type: "text", label: "Face Velocity Reading 2 (FPM)" },
        { id: "reading_3", type: "text", label: "Face Velocity Reading 3 (FPM)" },
        { id: "reading_4", type: "text", label: "Face Velocity Reading 4 (FPM)" },
        { id: "avg_fpm", type: "text", label: "Average Face Velocity (FPM)" },
        { id: "hood_open_area", type: "text", label: "Hood Opening Area (sq ft)" },
        { id: "calculated_cfm", type: "text", label: "Calculated CFM (FPM × sq ft)" }
      ],
      notesField: true
    },
    {
      id: "duct_plenum",
      title: "Exhaust Duct & Plenum",
      type: "checklist",
      items: [
        { id: "plenum_accessible", label: "Plenum access panel present and operable" },
        { id: "plenum_grease_light", label: "Plenum grease accumulation appears light to moderate" },
        { id: "plenum_grease_not_heavy", label: "No heavy dripping grease in plenum (fire hazard)" },
        { id: "duct_intact", label: "Visible duct sections intact — no separation or holes" },
        { id: "duct_slope", label: "Horizontal duct sloped back to hood (1/4\" per foot min)" },
        { id: "duct_clearance", label: "Duct clearance to combustibles maintained" },
        { id: "roof_penetration", label: "Roof penetration/duct enclosure in good condition (where visible)" }
      ],
      extraFields: [
        { id: "last_cleaning", type: "text", label: "Last Hood/Duct Cleaning Service Date" },
        {
          id: "cleaning_frequency",
          type: "radio",
          label: "NFPA 96 Required Cleaning Frequency",
          options: ["Monthly (High Volume)", "Quarterly (Moderate)", "Semi-Annual (Low)", "Annual (Solid Fuel)"]
        }
      ],
      notesField: true
    },
    {
      id: "fire_suppression",
      title: "Fire Suppression System (Visual Only — Do Not Touch)",
      type: "checklist",
      items: [
        { id: "suppression_present", label: "Fire suppression system present (Ansul or equivalent)" },
        { id: "service_tag_visible", label: "Service/inspection tag visible on system" },
        { id: "tag_current", label: "Service tag current — within 6-month inspection interval" },
        { id: "nozzles_visible", label: "Suppression nozzles visible and appear undamaged (visual only)" },
        { id: "nozzles_not_painted", label: "Suppression nozzle caps not painted over or obstructed" },
        { id: "pull_station_accessible", label: "Manual pull station accessible and labeled" },
        { id: "no_tampering", label: "No evidence of tampering or unauthorized alterations" }
      ],
      extraFields: [
        { id: "suppression_service_date", type: "text", label: "Last Suppression Service Date (from tag)" },
        { id: "suppression_company", type: "text", label: "Service Company (from tag)" }
      ],
      notesField: true
    },
    {
      ...
      type: "checklist",
      items: [
        { id: "switch_functional", label: "Hood on/off switch functional" },
        { id: "speed_control", label: "Variable speed control operational (if equipped)" },
        { id: "interlock_present", label: "Hood/cooking equipment interlock present" },
        { id: "wiring_condition", label: "Visible wiring in good condition — no damage" },
        { id: "disconnect_present", label: "Fan disconnect switch accessible and labeled" }
      ],
      notesField: true
    },
    {
      ...
      items: [
        { id: "action_none", label: "No action needed — all items pass" },
        { id: "action_filter_clean", label: "Filter cleaning needed" },
        { id: "action_filter_replace", label: "Filter replacement needed" },
        { id: "action_hood_clean", label: "Professional hood/duct cleaning needed (NFPA 96)" },
        { id: "action_fan_service", label: "Fan/motor service needed" },
        { id: "action_belt", label: "Belt replacement needed" },
        { id: "action_suppression", label: "Fire suppression inspection overdue — schedule licensed contractor" },
        { id: "action_airflow", label: "Airflow/CFM investigation needed" },
        { id: "action_other", label: "Other (see notes)" }
      ],
      extraFields: [
        {
...
EQUIPMENT_TYPES.commercial_range_griddle = {
  name: "Commercial Range / Griddle",
  icon: "🍳",
  sections: [
    {
      id: "gas_system",
      title: "Gas Supply & Manifold",
      type: "checklist",
      items: [
        { id: "shutoff_accessible", label: "Manual gas shutoff valve accessible and operational" },
        { id: "no_gas_leaks", label: "No gas leaks detected at connections (soap bubble/electronic)" },
        { id: "flex_connector", label: "Flexible gas connector in good condition — no kinks or corrosion" },
        { id: "drip_leg", label: "Drip leg/sediment trap installed" },
        { id: "manifold_pressure", label: "Manifold pressure within spec" },
        { id: "no_gas_odors", label: "No gas odors detected in kitchen" }
      ],
      extraFields: [
        { id: "inlet_pressure", type: "text", label: "Inlet Gas Pressure (in. W.C.)" },
        { id: "manifold_pressure_reading", type: "text", label: "Manifold Pressure (in. W.C.)" },
        {
          ...
          type: "radio",
          label: "Fuel Type",
          options: ["Natural Gas", "LP/Propane"]
        }
      ],
      notesField: true
    },
    {
      id: "burners_ignition",
      title: "Burners & Ignition",
      type: "checklist",
      items: [
        { id: "all_burners_light", label: "All burners light reliably" },
        { id: "flame_blue", label: "Burner flames even, blue — no yellow or orange tipping" },
        { id: "no_flame_lifting", label: "No flame lifting or flashback" },
        { id: "pilot_stable", label: "Standing pilot flame stable (if pilot ignition)" },
        { id: "spark_igniter", label: "Spark igniter generating spark (if electronic ignition)" },
        { id: "thermocouple_ok", label: "Thermocouple/flame sensor holding gas valve open" },
        { id: "burner_ports_clear", label: "Burner ports clear — no blockage or insect nests" }
      ],
      extraFields: [
        { id: "burner_count", type: "text", label: "Number of Burners" }
      ],
      notesField: true
    },
    {
      id: "griddle_section",
      title: "Griddle Surface (If Equipped)",
      type: "checklist",
      items: [
        { id: "griddle_surface", label: "Griddle plate free of warping, cracks, or pitting" },
        { id: "griddle_level", label: "Griddle plate level — drains toward grease trough" },
        { id: "grease_trough", label: "Grease trough and drain chute present and clear" },
        { id: "grease_trap_present", label: "Grease trap/drawer present and not overflowing" },
        { id: "griddle_temp_even", label: "Temperature reasonably even across surface" },
        { id: "griddle_thermostat", label: "Thermostat dial/control responsive" }
      ],
      extraFields: [
        { id: "griddle_set_temp", type: "text", label: "Griddle Set Temp (°F)" },
        { id: "griddle_actual_temp", type: "text", label: "Griddle Actual Temp (°F)" }
      ],
      notesField: true
    },
    {
      id: "oven_section",
      title: "Oven Section (If Equipped)",
      type: "checklist",
      items: [
        { id: "oven_door_seals", label: "Oven door closes fully and gasket intact" },
        { id: "oven_ignites", label: "Oven burner ignites reliably" },
        { id: "oven_flame_pattern", label: "Oven burner flame even and blue" },
        { id: "oven_temp_accurate", label: "Oven thermostat accurate — within 25°F of setpoint" },
        { id: "oven_safety_valve", label: "Oven safety valve functional" },
        { id: "oven_racks", label: "Oven racks slide smoothly and are undamaged" }
      ],
      extraFields: [
        { id: "oven_set_temp", type: "text", label: "Oven Set Temp (°F)" },
        { id: "oven_actual_temp", type: "text", label: "Oven Actual Temp (°F)" }
      ],
      notesField: true
    },
    {
      id: "structure_safety",
      title: "Structure, Safety & Clearances",
      type: "checklist",
      items: [
        { id: "legs_casters", label: "Legs/casters level and stable" },
        { id: "casters_locking", label: "Locking casters engaging and holding" },
        { id: "clearances_ok", label: "Side clearances from combustibles adequate" },
        { id: "under_hood", label: "Equipment positioned under exhaust hood canopy" },
        { id: "gas_connector_no_stress", label: "Flexible gas connector not under stress or kinked" },
        { id: "exterior_ok", label: "Exterior stainless free of major damage or sharp edges" }
      ],
      notesField: true
    },
    {
      ...
      items: [
        { id: "action_none", label: "No action needed — all items pass" },
        { id: "action_ignition", label: "Ignition system repair needed" },
        { id: "action_burner", label: "Burner cleaning or replacement needed" },
        { id: "action_thermostat", label: "Thermostat calibration/replacement needed" },
        { id: "action_gas", label: "Gas valve or regulator service needed" },
        { id: "action_griddle", label: "Griddle plate repair/resurfacing needed" },
        { id: "action_safety_valve", label: "Safety valve replacement needed" },
        { id: "action_other", label: "Other (see notes)" }
      ],
      extraFields: [
        {
...
EQUIPMENT_TYPES.make_up_air_unit = {
  ...
  sections: [
    {
      ...
      type: "checklist",
      items: [
        { id: "nameplate_legible", label: "Nameplate legible — make, model, serial recorded" },
        { id: "mounting_secure", label: "Unit mounting secure — no movement or loose hardware" },
        { id: "cabinet_sealed", label: "Cabinet panels sealed — no open holes or damaged sections" },
        { id: "no_corrosion", label: "No significant corrosion on cabinet or structural components" },
        { id: "clearances_ok", label: "Service clearances adequate for maintenance access" }
      ],
      extraFields: [
        { id: "mau_cfm", type: "text", label: "Rated CFM" },
        { id: "mau_model", type: "text", label: "Model Number" },
        { id: "mau_serial", type: "text", label: "Serial Number" }
      ],
      notesField: true
    },
    {
      ...
      type: "checklist",
      items: [
        { id: "intake_screen", label: "Outdoor air intake screen free of debris/blockage" },
        { id: "bird_screen", label: "Bird/vermin screen intact — no holes or gaps" },
        { id: "filter_present", label: "Air filter present and properly installed" },
        { id: "filter_condition", label: "Filter condition acceptable — not clogged" },
        { id: "filter_rack_sealed", label: "Filter rack/housing sealed — no air bypass around filter" }
      ],
      extraFields: [
        {
          id: "filter_condition_rating",
          type: "radio",
          label: "Filter Condition",
          options: ["Clean", "Change Soon", "Change Now"]
        }
      ],
      notesField: true
    },
    {
      id: "heating_section",
      title: "Heating Section",
      type: "checklist",
      items: [
        { id: "heating_present", label: "Heating section present and equipped" },
        { id: "gas_burner_ignites", label: "Gas burner ignites reliably (if gas-fired)" },
        { id: "gas_flame_pattern", label: "Flame pattern even and blue (if gas-fired)" },
        { id: "heat_exchanger_ok", label: "Heat exchanger free of cracks or soot (if gas-fired)" },
        { id: "electric_elements_ok", label: "Electric elements functioning (if electric)" },
        { id: "high_limit_ok", label: "High-limit safety switch not bypassed" },
        { id: "discharge_temp_ok", label: "Discharge air temperature adequate for application" }
      ],
      extraFields: [
        { id: "discharge_temp", type: "text", label: "Discharge Air Temp (°F)" },
        {
          id: "heat_type",
          type: "radio",
          label: "Heating Type",
          options: ["Gas-Fired", "Electric", "None / Tempered Only"]
        }
      ],
      notesField: true
    },
    {
      ...
      type: "checklist",
      items: [
        { id: "blower_running", label: "Blower operating when unit activated" },
        { id: "blower_smooth", label: "Blower motor free of unusual noise or vibration" },
        { id: "belt_condition", label: "Belt in good condition — no cracks or glazing (if belt drive)" },
        { id: "belt_tension", label: "Belt tension correct (if belt drive)" },
        { id: "motor_mounts_tight", label: "Motor mount tight — no looseness" },
        { id: "wheel_clean", label: "Blower wheel clean — no significant buildup" }
      ],
      extraFields: [
        { id: "blower_amps", type: "text", label: "Blower Motor Amps" },
        { id: "nameplate_fla", type: "text", label: "Motor Nameplate FLA" }
      ],
      notesField: true
    },
    {
      id: "controls_integration",
      title: "Controls & Integration",
      type: "checklist",
      items: [
        { id: "interlock_with_hood", label: "Interlock with exhaust hood — starts/stops with hood" },
        { id: "controls_functional", label: "All controls functional" },
        { id: "thermostat_working", label: "Supply air thermostat/controller functional" },
        { id: "economizer_ok", label: "Economizer damper functional (if equipped)" },
        { id: "electrical_tight", label: "All electrical connections tight and secure" },
        { id: "disconnect_present", label: "Unit disconnect accessible and labeled" }
      ],
      notesField: true
    },
    {
      ...
      items: [
        { id: "action_none", label: "No action needed — all items pass" },
        { id: "action_filter", label: "Filter replacement needed" },
        { id: "action_belt", label: "Belt replacement needed" },
        { id: "action_heating", label: "Heating section service needed" },
        { id: "action_motor", label: "Motor service needed" },
        { id: "action_controls", label: "Controls/interlock service needed" },
        { id: "action_balance", label: "CFM balancing/adjustment needed" },
        { id: "action_other", label: "Other (see notes)" }
      ],
      extraFields: [
        {
